...
function BenchmarkResultArray(capacity::Int)
  ...
  return BenchmarkResultArray(solve_times, prim_dual_gaps, prim_feas_errs, polytope_sizes, capacity, 0)
end

function add_result!(res_arr::BenchmarkResultArray, solve_time::Float64, prim_dual_gap::Float64, prim_feas_err::Float64)
...
function add_result!(res_arr::BenchmarkResultArray, solve_time::Float64, prim_dual_gap::Float64, prim_feas_err::Float64, polytope_size::Int)
  if res_arr.current_size < res_arr.capacity
    idx = res_arr.current_size + 1
    res_arr.solve_times[idx] = solve_time
    res_arr.prim_dual_gaps[idx] = prim_dual_gap
